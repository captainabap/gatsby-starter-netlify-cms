...
_Typische Ausdrücke in der Feldliste einer Transformationsroutine_
...
_Auslagern der Ausdrücke in eine skalare UDF_

Die ausgelagerten Funktionen sehen sehr viel eleganter aus. Und auch unter dem Aspekt der Wartung sind sie haushoch überlegen. Wenn beispielsweise ein weiteres Profitcenter in der Liste auftaucht, dann gibt es genau eine Funktion, die man anpassen muss. Am Beispiel von ZCL\_PROFCT=>TO\_PRBY zeige ich eine solche skalare AMDP Funktion:
...
_PlanViz der Abfrage mit Ausdruck_

![](images/eclipse_fxgrnDlEf9.png)

_PlanViz der Aubfrage mit UDF_
